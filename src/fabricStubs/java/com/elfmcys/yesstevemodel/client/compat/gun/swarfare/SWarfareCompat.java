...
public final class SWarfareCompat {
    ...
    public static void applyGunTransform(ItemStack stack, AnimatedGeoModel model, LivingEntity entity, PoseStack poseStack, int packedLight, float partialTick) {
    }

    @Nullable
    public static PlayState handleTaczAnim(LivingEntity entity, AnimationEvent<? extends LivingAnimatable<? extends LivingEntity>> event, String animation, ILoopType loopType) {
        return null;
    }
